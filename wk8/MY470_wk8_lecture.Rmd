...
Use the `c()` function to concatenate observations into a vector, rather than us [] like in python
...
series gives you integer
seq gives you numeric
...
note that R has recycled data for words and logical, because they're shorter than the number vectors. 
might be helpful or dangerous depending on what your objective is. 
...
note that in R, the '.' doesnt mean it's an attribute, so you can use it as part of the name, unlike in python.
